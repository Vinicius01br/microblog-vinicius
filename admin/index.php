...
<article class="p-5 my-4 rounded-3 bg-white shadow">
    <div class="container-fluid py-1">        
        ...
        <p class="fs-5">Você está no <b>painel de controle e administração</b> do site Microblog e seu <b>nível de acesso</b> é <span class="badge bg-dark"> <?=$_SESSION['tipo']?> </span>.</p>
        <hr class="my-4">
        ...
        <div class="d-grid gap-2 d-md-block text-center">
            ...
            <!-- Se for usuário do tipo admin, então mostre
            o link abaixo -->
